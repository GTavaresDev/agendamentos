...
export function ShellLayout({ children }: { children: React.ReactNode }) {
  ...
  const hasReportsPermission =
    isAdmin || currentUser?.permissions?.some((p) => p.name === "ver_relatorios");
  ...
  const getPageHeader = () => {
    if (pathname.includes("/agendamentos")) {
      return { title: "Agendamentos", subtitle: "Organize os horários e os atendimentos." };
    }
    ...
    return { title: `Olá, ${firstName}!`, subtitle: "Aqui está o resumo do seu dia." };
  };
