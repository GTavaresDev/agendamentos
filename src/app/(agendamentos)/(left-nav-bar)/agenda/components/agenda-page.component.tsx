...
import { AgendaView } from "@/app/(agendamentos)/(left-nav-bar)/agenda/components/agenda-view.component";
import { CreateAppointmentDialog } from "@/app/(agendamentos)/(left-nav-bar)/agenda/components/create-appointment-dialog.component";
