...
import { Calendar } from "@/app/(agendamentos)/(left-nav-bar)/_components/ui/calendar";
import {
  Card,
  CardContent,
  CardHeader,
...
import { ServiceBadge } from "@/app/(agendamentos)/(left-nav-bar)/_components/ui/service-color-indicator";
