...
import { CreateProductDialog } from "@/app/(agendamentos)/(left-nav-bar)/produtos/components/create-product-dialog.component";
import { ProductsTable } from "@/app/(agendamentos)/(left-nav-bar)/produtos/components/products-table.component";
